...
$__System.register('8', ['7', '9', 'a'], function (_export) {
	...
	function show_menuL1() {
		// Get header height to set top position of menu
		headerHeight = $('.header').outerHeight();
		//lg(`headerHeight: ${headerHeight}`);
		$menu.css({ 'top': headerHeight - 21 });
		// Animate the menu ---------------------------------
		$menuL1.addClass('no-transition');
		$menuL1.css({ 'height': 'auto' });
		menuL1height = $menuL1.outerHeight();
		$menuL1.css({ 'height': 0 });
		$menuL1.removeClass('no-transition');
		$menuL1.addClass('active');
		$menuL1.css({ 'height': menuL1height });
		// Set flyout menu min-height ---------------------------------
		$menuFlyout.css({ 'min-height': menuL1height });
		// Set menu max-height ---------------------------------
		debounce_remove_max_height_on_menu.cancel();
		$menu.css({ 'max-height': menuL1height });
		// Set menu to active ---------------------------------
	...
	function show_flyout() {
		...
		flyoutState = 1;
		debounce_remove_max_height_on_menu();
	}
	...
	return {
		...
		execute: function () {
			...
			debounce_show_flyout = _.debounce(show_flyout, 250);
...
$__System.registerDynamic('b', ['9'], true, function ($__require, exports, module) {
    ...
    (function (factory) {
        ...
        if (typeof undefined === 'function' && define.amd) {
            ...
            module.exports = factory($__require('9'));
        } else {
            factory(jQuery);
        }
    })(function ($) {
        ...
        Slick = function () {
            ...
            function Slick(element, settings) {
                ...
                _.defaults = {
                    ...
                    arrows: true,
                    asNavFor: null,
                    prevArrow: '<div class="button-bar button-bar-prev"><button type="button" data-role="none" class="slick-prev" aria-label="previous">Previous</button>',
                    nextArrow: '<div class="button-bar button-bar-next"><button type="button" data-role="none" class="slick-next" aria-label="next">Next</button>',
                    autoplay: false,
                    autoplaySpeed: 3000,
                    centerMode: false,
                    centerPadding: '50px',
...
$__System.register('e', ['9', 'c', 'a'], function (_export) {
	// =======================================================================================
	// DOM
	'use strict';
	...
	function playSlideshow() {
		playing = 1;
		$('.slick-dots').removeClass('paused');
		$slider.slick('slickPlay');
	}
	// ----------------- PAUSE SLIDESHOW -----------------
	function pauseSlideshow() {
		playing = 0;
		$('.slick-dots').addClass('paused');
	...
	return {
		...
		execute: function () {
			...
			$(window).on('load', function () {
				...
				switch (variant) {
					case '1':
						// Web Demo, hover on arrow
						$('body').addClass('slider-1');
						break;
					case '2':
						// Web Demo, hover on banner
						$('body').addClass('slider-2');
						break;
					case '3':
						// Larger Arrow, no hover
						$('body').addClass('slider-3');
						break;
					case '4':
						// Production
				...
				var $slickDots = $slider.find('.slick-dots'),
				    $dots = $slider.find('.slick-dots').find('li'),
				    $slickNext = $slider.find('.slick-next'),
				    $slickPrev = $slider.find('.slick-prev');
				// Get x pos of first dot
				firstDotX = $dots.first().offset().left;
				$slickDots.on('click', function (e) {
					// Use x pos of first dot compared to click to determine of play/pause icon clicked
					if (firstDotX - e.pageX > 7 && firstDotX - e.pageX < 22) {
						playPauseToggle();
					}
				});
				// New Events
...
$__System.register('1', ['8', 'a', 'e'], function (_export) {
